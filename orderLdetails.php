...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$qU = "UPDATE cust_order SET StatusUpdate = '$StatusUpdate', remarks = '$remarks' WHERE Order_Date = '$OrderDate' ";
...
<div class="btn-group" style="float: right; margin:-4.1em 0.5em">
	...
	<tr><th colspan="3">ORDER DETAILS</th>
		...
		<?php } else { ?>
			<tr><th style="text-align:right">Delivery Address:- </th><td rowspan=2 colspan="2" style="text-align:left"><b><?php echo $DeliMeth?></b></td></tr>
			<tr><th style="text-align:right">Delivery Method:- </th></tr>
		<?php } ?>
		...
		<form action="orderLdetails.php" id=statupd method="POST">
			...
			<tr><th style="text-align:right">Remark(s):- </th><td colspan="2" style="text-align:left">
				<textarea name=remarks cols="50" rows="5"><?php if(!empty($dataPre['remarks'])) { echo $dataPre['remarks'];}else{echo 'None';}?></textarea></td>
				<td style="text-align:center"><input type="submit" name="submit" value="Save Changes"></td>
			</tr>
